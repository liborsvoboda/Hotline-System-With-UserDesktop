...
document.getElementById("newstep").style.display="none";
document.getElementById("newrequest").style.display="none";close_tab();
document.getElementById("history").disabled=false;
    ...
    script.src = "./history_task_manager.php?id="+v1;
    document.getElementsByTagName('head')[0].appendChild(script);
    //document.getElementById("funct_btn1").disabled =true;
...
function addstep(){        // zobrazeni newstep
    if (document.getElementById("newstep").style.display!="none") {
        document.getElementById("newstep").style.display="none";close_tab();
        document.getElementById("history").disabled=false;
    } else {
...
var solver = previous_step_data[3];
      for (i = 0; i < document.getElementById("nsvalue8").options.length; i++) {
        if (solver.search(document.getElementById("nsvalue8").options[i].value) >= 0 ){
            document.getElementById("nsvalue8").options[i].selected=true;
        } else {document.getElementById("nsvalue8").options[i].selected=false;}
      }
...
var usr_group = previous_step_data[7];
      for (i = 0; i < document.getElementById("nsvalue9").options.length; i++) {
        if (usr_group.search(document.getElementById("nsvalue9").options[i].value) >= 0 ){
            document.getElementById("nsvalue9").options[i].selected=true;
        } else {document.getElementById("nsvalue9").options[i].selected=false;}
      }
...
function addrequest(){        // zobrazeni newrequest
    if (document.getElementById("newrequest").style.display!="none") {document.getElementById("newrequest").style.display="none";close_tab();}
            ...
            document.getElementById("history").style.display="none";
            document.getElementById("newstep").style.display="none";
            document.getElementById("nrvalue8").style.backgroundColor="FFDEB5";
        }
}
...
function editrequest(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,laststatus){
    ...
    if (v5!=''){
    	...
    	document.getElementById("rfile").href="./ajax_functions.php?show_file=yes&tbl=task_manager_request&id="+v6;
...
function print_to_pdf(value){
//    alert(document.getElementById('ht_request').innerHTML);
    
    window.open("./outputs/task_manager_pdf.php?id="+value,value,'');
//window.open('./outputs/neco.php');
