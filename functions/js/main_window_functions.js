...
document.write('<DIV id=login style=z-index:10000;color:#000080;background:silver;><form action="'+document.URL+'" method=post enctype="multipart/form-data"><table border=0 cellpading=0 cellspacing=0 style=color:#000080;><tr><td colspan=2 align=center><b><?echo dictionary("userlogin",$_SESSION["language"]);?></b></td></tr><tr><td><?echo dictionary("username",$_SESSION["language"]);?></td><td><input id=lgvalue1 /*onkeyup=allow_when_selected("input|input","lgvalue1|lgvalue2","lgbtn","DISABLE");*/ name="user" type="text" value="" style=width:180px;text-align:center;></td></tr><tr><td><?echo dictionary("password",$_SESSION["language"]);?></td><td><input id=lgvalue2 /*onkeyup=allow_when_selected("input|input","lgvalue1|lgvalue2","lgbtn","DISABLE");*/ name="password" type="password" value="" style=width:180px;text-align:center;></td></tr><tr><td></td><td align=right><input id=lgbtn /*disabled*/ type="submit" value="<?echo dictionary("login",$_SESSION["language"]);?>"></td></tr></table></form><div style=position:absolute;right:5px;top:5px;cursor:pointer; onclick=document.getElementById("login").style.display="none"; ><img src="./images/close.png" border="0" width="12" height="12" alt="<?echo dictionary("close",$_SESSION["language"]);?>"></div></DIV>');
document.getElementById("login").style.display="none";

document.write('<iframe id="sesswindow" style="position:absolute;right:50px;z-index:1;" ></iframe>');
document.getElementById("sesswindow").style.display="none";

function sesscrt(value){
document.getElementById("sesswindow").src ='./functions/php/access.inc.php?RTG='+value;
}
...
function check_source(value,value1){
     try {document.getElementById(value).src}
     catch ( e ) {fn_off_display(value1);}
  fn_off_display(value1);
}
